...
const UnFixedNavbar = ({ handleDrawerOpen }) => {
  ...
  return (
    <div className="w-full h-12  shadow-2xl xl:px-32 px-4 bg-orange-500 dark:bg-[#242526] xl:block flex items-center justify-start">
...
UnFixedNavbar.propTypes = {
  handleDrawerOpen: PropTypes.func.isRequired,
};

export default UnFixedNavbar;
