  ...
  return (
    <div className="w-full   flex flex-col  bg-white dark:bg-[#18191A] py-4 z-0">
      <div className="h-screen w-full flex justify-center lg:px-10 px-4 py-2 bg-custom-image bg-cover bg-center bg-no-repeat">
        ...
        <form className="form bg-white p-8 rounded-xl lg:w-[500px] w-full h-fit mt-10  ">
          ...
          <Link to="/Home">
            <button className="button-submit bg-black text-white font-semibold py-2   w-full rounded-lg mt-6">
              Sign In
            </button>
          </Link>
          ...
          <div className="flex gap-4 my-6">
            <button className="btn google p-3 gap-3 bg-white border w-full border-gray-300 rounded-lg flex items-center justify-center font-semibold">
              <svg
                version="1.1"
                width="20"
                id="Layer_1"
