...
import { loginUser, loginUserWithGoogle } from "../../Redux/authSlice"; // Import loginUser
...
function LoginForm() {
  ...
  const responseGoogle = async (response) => {
    ...
    const result = await dispatch(loginUserWithGoogle(tokenId)); // Dispatch the new action
