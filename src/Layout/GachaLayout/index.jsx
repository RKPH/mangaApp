...
const GachaLayout = ({ children }) => {
  ...
  let timeoutId;
  return (
    <div ref={headerRef} className=" w-full h-screen font-mono">
      ...
      <div className="w-full h-screen flex xl:flex-row ">
        <div className=" xl:px-32 lg:px-4  w-full    bg-white dark:bg-[#18191A] h-full  ">
          {children}
        </div>
      </div>
